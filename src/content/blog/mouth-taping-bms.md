...
heroImage: "/thumbnails/tape-dark.jpg"
draft: false
---
	...
	<div class="stat-card">
		...
		<div class="stat-visualization-wrapper">
			<div class="stat-dots-grid">
				...
				<div class="stat-dot active"></div><div class="stat-dot active"></div><div class="stat-dot active"></div><div class="stat-dot active"></div><div class="stat-dot"></div>
			</div>
		</div>
...
<div style="background: white; padding: 2rem 2rem 0.5rem 2rem; border-radius: 12px; max-width: 600px; margin: 2rem auto; box-shadow: 0 4px 20px rgba(0,0,0,0.3);">

![Breath: The New Science of a Lost Art by James Nestor](../../assets/breath-book-cover.png)
